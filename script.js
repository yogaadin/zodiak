...
const zodiacLibrary = {
    ...
    taurus: {
        ...
        matchWith: "Capricorn & Virgo", baseComp: 99,
    ...
    capricorn: {
        ...
        matchWith: "Taurus & Virgo", baseComp: 99,
...
// ramalan generator - match with moved to right side
function generateForecast() {
    ...
    // Extract main match partner (first one)
    const mainMatch = data.matchWith.split('&')[0].trim();
        ...
        <div class="zod-card">
            <div class="card-header">
                ...
                <div class="match-wrapper">
                    ...
                    <div class="match-label">🤝 match with ${mainMatch}</div>
                </div>
            </div>
